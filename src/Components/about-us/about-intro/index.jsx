    ...
    return (
        <section className="about-us-intro">
            ...
            <div className="about-us-intro-content">
                ...
                <p>Mostly Digital is a tech-enabled digital marketing solutions provider, and we create custom strategies for each of our clients based on their needs and goals.</p>
            </div>
        </section>
    );
};
